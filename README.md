...
因为研究的需要，不想用excel重复地粘贴复制，决定用python写一个计算EMPA数据的程序。一是可以大量处理数据，二是看着代码能回快速想起来数据的计算方法，第三则是想用python写个程序锻炼下。断断续续自学了那么久的python，还从来没正经写过程序，这个算是处女作了。熟悉了python，体会到了pandas的强大，学会了使用git。编写程序整个过程带来的影响远大于代码本身。
